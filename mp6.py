...
mypath = "C:\\Users\\Admin\\Desktop\\Ibrutinib automation\\Exp 2024-08-08 12-59"
...
def function2():
    time.sleep(150) # Last 3 minutes
    files = [f for f in listdir(mypath) if isfile(join(mypath, f))]

    val = 0
    
    #change wavelengths as per product here.
    f_row=12 #first row of range for wavelength as per IR CSV
    l_row=18 #last row of range for wavelength as per IR CSV
...
bounds = [(.02,0.05),(0.05,1.5),(30.0,50.0),(5.0,10.0)]
