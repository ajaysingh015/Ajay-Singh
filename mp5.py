...
mypath = "C:\\Users\\Admin\\Desktop\\Ibrutinib automation\\Exp 2024-08-05 14-46"
...
pump_2 = serial.Serial("COM18",9600) #Syringe Pump
...
def function2():
    time.sleep(300) # Last 3 minutes
    files = [f for f in listdir(mypath) if isfile(join(mypath, f))]

    val = 0
    
    #change wavelengths as per product here.
    f_row=14 #first row of range for wavelength as per IR CSV
    l_row=20 #last row of range for wavelength as per IR CSV
...
bounds = [(0.04,0.1),(0.04,0.1),(110.0,150.0),(5.0,10.0)]
